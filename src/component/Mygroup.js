                                ...
                                <div className='flex py-4 border-b-2 items-center'>
                                    ...
                                    {delateBox && collectdata.includes(item.groupAdminId + item.groupid)
                                     ?
                                        ...
                                        : reqModal && collectdata.includes(item.groupAdminId + item.groupid) && ''
                                        //    joinReqList.map(()=>{
                                            ...
                                            //             </div>
                                            //             <div>
                                            //                 <h2 className='font-semibold font-poppins text-sm mt-2'></h2>
                                            //                 <p className='font-medium font-poppins text-xs text-shadow'></p>
                                            //             </div>
